function [out] = SREG_II (data,imagesize,options)
...
GM = GM_gen(d1,d2,d3,2,flag,index);
...
for tune_i = 1:n_lambda1;
    for tune_j = 1:n_lambda2
        ...
        v2 = zeros((p_org+1),1);
        if d3>1
            v3 = zeros((10*p_org+1), 1);
        elseif d2>1            
            v3 = zeros((5*p_org+1), 1);
        else
        ...
        [GB,bccb] = GB_gen(lambda1,lambda2,d1,d2,d3,2);
